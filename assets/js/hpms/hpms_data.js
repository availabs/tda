(function() {
	...
	function addState(data) {
		var xhr = d3.json('http://api.availabs.org/hpms/hpms/'+data.datum+'/state_data', function(error, response) {
	...
	function addInterstate(data) {
		var xhr = d3.json('http://api.availabs.org/hpms/hpms/'+data.datum+'/interstate_data', function(error, response) {
